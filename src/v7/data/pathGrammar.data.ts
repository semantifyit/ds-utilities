...
export const pathGrammarNodeTypeDefinitionInternal =
  "InternalReferenceDefinition"; // possible start
export const pathGrammarNodeTypeDefinitionExternal =
  "ExternalReferenceDefinition"; // possible start
export const pathGrammarNodeTypeDefinitionInternalExternal =
...
export const pathGrammarNodeTypeReferenceInternalExternal =
