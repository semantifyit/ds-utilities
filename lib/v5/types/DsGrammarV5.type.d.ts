...
export declare type ContextV5 = (typeof standardContext) & ContextGeneric;
export declare type DsV5 = {
    "@context": ContextV5;
    "@graph": [RootNodeV5];
    "@id": string;
};
export declare type DsNodeV5 = DsV5 | ContextV5 | RootNodeV5 | PropertyNodeV5 | DataTypeNodeV5 | ClassNodeV5 | EnumerationNodeV5;
export declare type RootNodeV5 = {
    "@id"?: string;
    "@type": ["sh:NodeShape", "schema:CreativeWork"] | ["schema:CreativeWork", "sh:NodeShape"];
...
export declare type PropertyNodeV5 = {
...
export declare type DataTypeNodeV5 = {
...
export declare type ClassNodeV5 = {
...
export declare type EnumerationMemberNodeV5 = {
    "@id": string;
};
export declare type EnumerationNodeV5 = {
    "sh:class": string;
    "sh:in"?: EnumerationMemberNodeV5[];
};
export declare type DsGrammarNodeTypeV5 = typeof dsGrammarNodeTypes[keyof typeof dsGrammarNodeTypes];
//# sourceMappingURL=DsGrammarV5.type.d.ts.map