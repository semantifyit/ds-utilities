...
describe("v7 - dsPathIdentifyNodeType()", () => {
  test("root node", () => {
    ...
    expect(dsu.dsPathIdentifyNodeType(rootNode, dsDs2 as DsV7)).toBe(
      "RootNode"
    );
  });
  test("property", () => {
    ...
    expect(dsu.dsPathIdentifyNodeType(propertyNode, dsDs2 as DsV7)).toBe(
      "Property"
    );
  });
  test("DataType", () => {
  ...
  test("Enumeration", () => {
    ...
    expect(dsu.dsPathIdentifyNodeType(enumNode, dsDs2 as DsV7)).toBe(
      "Enumeration"
    );
  });
  test("Internal reference", () => {
    ...
    expect(
      dsu.dsPathIdentifyNodeType(internalReferenceNode, dsDs2 as DsV7)
    ).toBe("InternalReference");
  });
  test("External reference", () => {
    ...
    expect(
      dsu.dsPathIdentifyNodeType(externalReferenceNode, dsDs2 as DsV7)
    ).toBe("ExternalReference");
  });
  test("External internal reference", () => {
    ...
    expect(
      dsu.dsPathIdentifyNodeType(internalExternalRefNode, dsDs2 as DsV7)
    ).toBe("InternalExternalReference");
  });
  test("Internal reference definition", () => {
    const dsu = new DsUtilitiesV7();
    const intRefDef = dsu.dsPathGetNode(dsDs2 as DsV7, "#UhVfN");
    expect(dsu.dsPathIdentifyNodeType(intRefDef, dsDs2 as DsV7)).toBe(
  ...
  test("External reference definition", () => {
    ...
    expect(dsu.dsPathIdentifyNodeType(extRefDef, dsDs2 as DsV7)).toBe(
