...
const helper=_dereq_("./../../helperFunctions.js"),data=_dereq_("./../data/dataV7.js"),{customAlphabet:customAlphabet}=_dereq_("nanoid"),{isObject:isObject}=_dereq_("../../helperFunctions.js"),getDsRootNodeV7=e=>{if(!e["@graph"])throw new Error("The given DS has no @graph array, which is mandatory for a DS in DS-V7 format.");const r=e["@graph"].find(e=>"ds:DomainSpecification"===e["@type"]);if(!r)throw new Error("The given DS has no identifiable root node in DS-V7 format.");return r},getDsStandardContextV7=()=>helper.jhcpy(data.standardContext),getDsIdV7=e=>{const r=getDsRootNodeV7(e);if(!r["@id"])throw new Error("The given DS has no @id for its root node, which is mandatory for a DS in DS-V7 format.");return r["@id"]},reorderDsV7=e=>{if(!isObject(e))throw new Error("The given input was not an object, as required.");const r=e=>{for(const r of e)helper.reorderNodeBasedOnNodeTermArray(r,data.nodeTermsLanguageTaggedValue)},o=e=>{if(reorderDsNodeV7(e),e["schema:name"]&&r(e["schema:name"]),e["schema:description"]&&r(e["schema:description"]),e["sh:property"])for(const r of e["sh:property"])s(r)},s=e=>{reorderDsNodeV7(e),e["rdfs:comment"]&&r(e["rdfs:comment"]);for(const r of e["sh:or"])reorderDsNodeV7(r),r["sh:node"]&&o(r["sh:node"])};helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsDsObject),helper.reorderNodeBasedOnNodeTermArray(e["@context"],data.nodeTermsContext());const t=e["@graph"].findIndex(e=>"ds:DomainSpecification"===e["@type"]);0!==t&&(e["@graph"]=[e["@graph"][t],...e["@graph"].slice(0,t),...e["@graph"].slice(t+1)]);for(const r of e["@graph"])o(r)},reorderDsNodeV7=e=>{if(!isObject(e))throw new Error("The given input was not an object, as required.");if(e["@type"])switch(e["@type"]){case"ds:DomainSpecification":helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsRootNode);break;case"sh:PropertyShape":helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsPropertyNode);break;case"sh:NodeShape":e["sh:in"]?helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsEnumerationNode):helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsClassNode)}else e["@context"]?helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsDsObject):e.ds&&e.schema&&e.sh?helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsContext()):e["sh:datatype"]?helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsDataTypeNode):e["sh:node"]||e["@value"]&&helper.reorderNodeBasedOnNodeTermArray(e,data.nodeTermsLanguageTaggedValue)},generateInnerNodeIdV7=e=>{let r,o;e&&(r=getDsIdV7(e));const s=customAlphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",5);do{o=s()}while(void 0!==e&&JSON.stringify(e).includes(r+"#"+o));return o},getDsNameV7=(e,r)=>{const o=getDsRootNodeV7(e);if(o["schema:name"])return helper.getLanguageString(o["schema:name"],r)},getDsDescriptionV7=(e,r)=>{const o=getDsRootNodeV7(e);if(o["schema:description"])return helper.getLanguageString(o["schema:description"],r)},getDsAuthorNameV7=e=>{const r=getDsRootNodeV7(e);if(r["schema:author"]&&r["schema:author"]["schema:name"])return r["schema:author"]["schema:name"]},getDsSchemaVersionV7=e=>{const r=getDsRootNodeV7(e);if(!r["schema:schemaVersion"])throw new Error("The given DS has no schema:schemaVersion for its root node, which is mandatory for a DS in DS-V7 format.");return r["schema:schemaVersion"]},getDsVersionV7=e=>{const r=getDsRootNodeV7(e);if(r["schema:version"])return r["schema:version"]},getDsExternalVocabulariesV7=e=>{const r=getDsRootNodeV7(e);return r["ds:usedVocabulary"]?r["ds:usedVocabulary"]:[]},getDsTargetClassesV7=e=>{const r=getDsRootNodeV7(e);return r["sh:targetClass"]?r["sh:targetClass"]:[]};module.exports={getDsRootNodeV7:getDsRootNodeV7,getDsStandardContextV7:getDsStandardContextV7,getDsIdV7:getDsIdV7,reorderDsV7:reorderDsV7,reorderDsNodeV7:reorderDsNodeV7,generateInnerNodeIdV7:generateInnerNodeIdV7,getDsNameV7:getDsNameV7,getDsDescriptionV7:getDsDescriptionV7,getDsAuthorNameV7:getDsAuthorNameV7,getDsSchemaVersionV7:getDsSchemaVersionV7,getDsVersionV7:getDsVersionV7,getDsExternalVocabulariesV7:getDsExternalVocabulariesV7,getDsTargetClassesV7:getDsTargetClassesV7};
